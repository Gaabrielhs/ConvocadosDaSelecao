package dev.gabrielhenrique.tiratime.ui.theme
...
fun ConvocadosDaSelecaoTheme(
    ...
    MaterialTheme(
        colorScheme = colors,
//        typography = Typography, TODO: Create a custom typography
        content = content
    )
}
...
fun Color.toHex(): String {
    ...
    // Combine the channels into a hex string
